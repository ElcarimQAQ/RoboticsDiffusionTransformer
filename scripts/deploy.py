...
# === Server Interface ===
class RDTServer:
    def __init__(self, rdt_path: Union[str, Path], attn_implementation: Optional[str] = "flash_attention_2") -> Path:
        """
...
class DeployConfig:
    # fmt: off
    rdt_path: Union[str, Path] = "/home/lbyang/workspace/llm-robot/openvla/exp/openvla-7b+libero_spatial_no_noops+b8+lr-0.0005+lora-r32+dropout-0.0"               # HF Hub Path (or path to local run directory)
